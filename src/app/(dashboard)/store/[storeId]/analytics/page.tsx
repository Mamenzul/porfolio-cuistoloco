    ...
    <div className="space-y-6 p-1">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <OverviewCard
          ...
          description="Revenue total de votre magasin"
          icon="dollarSign"
        />
        <OverviewCard
          title="Ventes"
          ...
          description="Total des ventes de votre magasin"
          icon="credit"
        />
        <OverviewCard
          title="Commandes"
          value={formatNumber(orderCount)}
          description="Total des commandes de votre magasin"
          icon="cart"
        />
        <OverviewCard
          title="Clients"
          value={formatNumber(customerCount)}
          description="Les clients de votre magasin"
          icon="activity"
        />
      </div>
      <div className="flex flex-col gap-4 2xl:flex-row">
        <Card className="flex-1">
          <CardHeader>
            ...
            <CardDescription>
              Ventes totales au cours des {dayCount} derniers jours
            </CardDescription>
          </CardHeader>
          <CardContent>
            <SalesChart
              data={sales.map((sale) => ({
                month: format(new Date(sale.year, sale.month - 1), "MMM"),
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Clients qui ont acheté au cours des {dayCount} derniers jours
            </CardDescription>
          </CardHeader>
