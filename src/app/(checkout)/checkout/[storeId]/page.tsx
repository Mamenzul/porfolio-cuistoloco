...
export const metadata: Metadata = {
  ...
  description: "Encaisser les articles de votre panier",
};
      ...
      <Shell variant="centered">
        <div className="flex flex-col items-center justify-center gap-2 pt-20">
          <div className="text-center text-2xl font-bold">
            Le magasin n&apos;est pas connecté à Stripe
          </div>
          <div className="text-center text-muted-foreground">
            Le patron du magasin doit se connecter à Stripe pour accepter les
            paiements
          </div>
          <Link
